...
public class CssSelectorPractice {
    ...
    public static void main(String[] args) {
        ...
        // we will find all buttons that have: class="btn btn-primary"
        // or like this [class='btn btn-primary']  no need to put . between btn's
        // . means class name
        // # means id
        ...
        // find element with a tag name that has a parent element with class name "container"
